...
using AuthSystemMVC.ViewModels.AccountViewModels;
...
namespace AuthSystemMVC.Controllers
{
	...
	public class AccountController : Controller
	{
		...
		[AllowAnonymous]
		[ValidateAntiForgeryToken]
		public async Task<IActionResult> Register(RegisterViewModel model, [FromQuery] string? ReturnUrl)
		{
			ViewData["ReturnUrl"] = ReturnUrl;
			if (ModelState.IsValid)
			{
		...
		[AllowAnonymous]
		[ValidateAntiForgeryToken]
		public async Task<IActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, [FromQuery] string? ReturnUrl)
		{
			if (ModelState.IsValid)
			{
				...
				var stringuserDOB = info.Principal.FindFirstValue(ClaimTypes.DateOfBirth);
				DateTime resultsDOB = DateTime.MinValue;
				DateTime.TryParse(stringuserDOB, out resultsDOB);
